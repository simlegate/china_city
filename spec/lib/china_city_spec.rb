...
describe ChinaCity do
  ...
  it "should can search" do
    ChinaCity.search("四川").should eql [{"text"=>"四川省", "id"=>"510000"}]
    ChinaCity.search("香港").should eql [{"text"=>"香港特别行政区", "id"=>"810000"}]
  end
end
